...
count_object = [{1: 12}, {2: 12}, {3: 12}, {4: 12}]
...
num_cycles = 10
initial_frequency = 200  # Initial frequency for higher tone
...
for h in range(num_cycles):
    ...
    for i in range(4):
        ...
        for j in range(current_count):
            ...
            base_frequency *= whole_step_factor  # Increase frequency by one whole note for the next tone
